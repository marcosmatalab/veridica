...
| 3 | `SOLAPE_MINIMO` (portero de frases) | 0,50 | 4.5 | **SIGUE SIN CALIBRAR**, con el motivo CORREGIDO por el 2.5: el denominador **sí** estaba (204 respuestas con sus frases contadas); faltaba el **valor** —el solape de cada frase—, que desde el 2.5 se persiste ([evidencia](2026-08-14-traza-completa-2.5.md) §2) |
...
| 5 | vigilante de ritmo | 35 tok/s, ventana 2 s | 3.4bis, declarado sin calibrar | **SIGUE SIN CALIBRAR**, con el motivo CORREGIDO por el 2.5: el ritmo por consulta **sí** se persistía (330 de 391 respuestas), pero era el de la **última ventana** y el umbral juzga el **peor momento**; desde el 2.5 se guarda `minimo_observado` ([evidencia](2026-08-14-traza-completa-2.5.md) §2) |
