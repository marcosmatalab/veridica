...
- **DOS ERRORES QUE SE COMPENSAN PRODUCEN UN NÚMERO QUE PARECE CONFIRMADO, y ese acuerdo es la forma más peligrosa de validación falsa que existe: no hay nada que mirar, porque *sale lo mismo*.** El caso, del 14 de agosto de 2026, es el número de cabecera del proyecto, y hay que leerlo con su segunda mitad porque la primera vez lo conté mal. Publicado: **57,9 %** de citas literales que lo son de verdad (195/337, **filas**). Recontado por casos distintos: **57,1 %** — y ese parecido se leyó como *«el titular aguanta»*. **No aguantaba: la cifra correcta es 50,9 %**, siete puntos peor. El 57,1 llevaba **dos** desviaciones en direcciones **opuestas** que se cancelaban: deduplicar bajaba el número **siete puntos** (57,9 → 50,9, porque las citas cortas y fáciles son las que más se repiten y la repetición maquillaba a favor del sistema) y una **población mal elegida** lo subía **seis** (50,9 → 57,1). **Y la primera versión de esta regla nombró mal la segunda desviación** —dijo *«dos denominadores mezclados, 195 de una tabla de 328 sobre 337 emitidas»*— y eso también era falso: sobre la ventana reconstruida, 195/337 sale **dígito a dígito**. O sea que el mecanismo de la regla se confirma y la autópsia se equivocó de órgano, que es la moraleja dentro de la moraleja: **un parecido no solo calla la comprobación del número, calla también la de su explicación.** **La comprobación: cuando un número re-medido salga parecido al viejo, tratar el parecido como SOSPECHA y no como acuerdo** —misma población y misma unidad, comprobadas por separado, con la regla de al lado (reproducir la cifra vieja antes de corregirla) como primer paso—, **y escribir el aviso junto a la cifra**, porque el siguiente que la repita no tendrá esta conversación delante. Es hermana de «una explicación elegante es una señal de riesgo»: allí calla la comprobación un porqué que encaja demasiado bien; aquí la calla un número que coincide demasiado bien.
