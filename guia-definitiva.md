...
Y la línea que lo arregla **no es gratis**, con su número: en la consulta de IVA en modo `corregir`, **7 de 10 corridas** chocan con el tope de 900 tokens, contra **0 de 3** sin ella. Los crudos dicen que no es un bucle —las que terminan gastan 471-641 tokens con 8 y 9 afirmaciones—: el tipo nuevo alarga la respuesta y el tope se queda corto. **Arreglo propuesto y no construido, que es contrato y no prompt:** acotar `afirmaciones` con `maxItems`, derivado de que las 110 respuestas reales van de 1 a 6 y ninguna pasa de 6. Esta vez sí es algo que la gramática puede imponer.
