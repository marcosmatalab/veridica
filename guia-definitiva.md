...
- **UN UMBRAL PUEDE ESTAR MIDIENDO LA LIMITACIÓN DE SU INSTRUMENTO EN VEZ DE LA DIFICULTAD DEL PROBLEMA, y la señal de que eso pasa es que SOBREVIVE A CALIBRACIONES SUCESIVAS SIN MOVERSE.** El caso, del 14 de agosto de 2026: el 0,60 del NLI aguantó **tres** barridos —corridas 32, 36 y 38, con la premisa cambiada dos veces por el medio— y eso se leyó como robustez. No lo era. La prueba que lo destapa no necesita etiquetado ni humanos ni desempate: **dar al juez una IDENTIDAD**, o sea una hipótesis que está literalmente dentro de su premisa. Sobre 60 identidades reales, mDeBERTa-v3-base contesta **`neutral` en el 20 %** —que un texto no se sigue de sí mismo— y, cuando aprueba, su probabilidad tiene **mediana 0,66 y mínimo 0,545**. O sea que el 0,60 no está donde está por bueno: **está clavado justo debajo de la mediana de las identidades, que es donde el modelo le deja estar.** Un umbral así no mide *"cuánta evidencia hace falta"*, mide *"hasta dónde llega este modelo"*, y cualquier mejora de premisa, de selección o de datos se estrella contra él sin que nada se ponga rojo. **La comprobación, y cuesta una hora: antes de dar por bueno un umbral, pásale al instrumento el caso trivialmente cierto de su tarea** —la identidad para un NLI, el duplicado exacto para un deduplicador, la misma imagen para un comparador— **y mira qué contesta.** Lo que no apruebe ahí es su techo, no tu problema.
