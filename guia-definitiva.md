...
3. **Los 512 tokens se cuentan con el tokenizador REAL de BGE-M3**, no con una estimación por palabras o caracteres. Medido: la prosa castellana cunde 4,6 caracteres por token y el código 2,3, o sea que una estimación uniforme se equivoca al doble justo en el material de Programación. Si el troceado y el modelo no cuentan igual, el tamaño de fragmento del README no es el que existe.
